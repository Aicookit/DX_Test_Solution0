...
void CModel::Render(CDevice * pDevice)
{
	D3DXMATRIX translate, rotate, scale;      // control model translate, rotate, scale
	D3DXMatrixTranslation(&translate, m_vPos.x, m_vPos.y, m_vPos.z);  //obj local coordinate
